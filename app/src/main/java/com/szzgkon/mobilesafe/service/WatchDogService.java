...
import com.szzgkon.mobilesafe.activity.EnterPwdActivity;
...
//    临时停止保护的包名
    ...
    private class WatchDogReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if(intent.getAction().equals("com.szzgkon.mobilesafe.stopprotect")){
                //获取到停止保护的对象
    ...
    public void onCreate() {
        ...
        //停止保护
        filter.addAction("com.szzgkon.mobilesafe.stopprotect");
