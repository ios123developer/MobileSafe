        ...
        switch (v.getId()) {
            ...
            case R.id.ll_share:
                ...
                share_localIntent.putExtra("android.intent.extra.TEXT",
                        "Hi！推荐您使用软件：" + clickAppInfo.getApkName()+"下载地址:"+"https://play.google.com/store/apps/details?id="+clickAppInfo.getApkPackName());
            ...
            case R.id.ll_start:
                ...
                Intent start_localIntent = this.getPackageManager().getLaunchIntentForPackage(clickAppInfo.getApkPackName());
            ...
            case R.id.ll_uninstall:
                ...
                Intent uninstall_localIntent = new Intent("android.intent.action.DELETE", Uri.parse("package:" + clickAppInfo.getApkPackName()));
            ...
            case R.id.ll_detail:
                ...
                detail_intent.setData(Uri.parse("package:" + clickAppInfo.getApkPackName()));
